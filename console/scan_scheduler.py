...
def main():
    ...
    for scan in scans:
        ...
        # Site model as a foreign key, and in turn, the Site model has foreign keys for the Engine and ScanCommand models
        # (see the scantron_model_graph.png for a visualization).  Therefore, if a field from the Engine or
        ...
        # API are controlled using console/api/serializers.py.
        ...
        # Build result_file_base_name file.  "__" is used by console/scan_results/nmap_to_csv.py to .split() site_name
        # and scan_engine.
